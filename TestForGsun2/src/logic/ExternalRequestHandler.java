...
public class ExternalRequestHandler {
	...
	/**
	 * rturn a list of needs
	 * @return
	 */
	public List<Entry> getAllNeeds(){
		PlacesDbHandler pldbh=null;
		try {
			pldbh = new PlacesDbHandler();
		} catch (Exception e) {
			// TODO Auto-generated catch block
			System.out.println("Error while getting all need list");
		}
		
		return pldbh.getAllNeeds();
